...
<section class="collection">
    <h2>Phone Strap Collection</h2>

    <div class="products">
        <?php
        $products = [
            ['id'=>'ps1','name'=>'Beaded Phone Strap','price'=>12000,'img'=>'phone-strap.jpg'],
            ['id'=>'ps2','name'=>'Pastel Strap','price'=>12000,'img'=>'phone-strap.jpg']
        ];
